...
age_border = 18
is_older = True if int(age) >= age_border else False
...
if is_older:
    ...
    print(
        f"Aun eres menor de edad!!! Tienes {age} años y te falta {age_diff} años para cumplir {age_border} años."
    )
