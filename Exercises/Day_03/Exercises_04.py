...
print(
    f"Comprobando si la sub-cadena 'videos' existe en la oracion 'Aprendiendo python desde cero': {videos_word_exist_in_sentence}"
)
print("\n")

# 6.-
string_before_replacement = "Aprendiendo typescript desde cero"
replacing_typescript_with_python = string_before_replacement.replace(
    "typescript", "python"
)
print(f"Oracion antes del reemplazo: {string_before_replacement}")
print(
    f"Oracion reemplazando 'typescript' con 'python': {replacing_typescript_with_python}"
)
print("\n")
...
# 9.4.-
print(
    f'La primera aparición del caracter "C" es en la posicion: {sentence2.index('C')}'
)

# 9.5.-
print(
    f'La primera aparición del caracter "n" es en la posicion: {sentence2.index('n')}'
)
...
# 9.7.-
print(
    f'La primera aparición de la palabra "porque" es en la posicion: {sentence.find('porque')}'
)

# 9.8.-
print(
    f'La última aparición de la palabra "porque" es en la posicion: {sentence.rfind('porque')}'
)

# 9.9.-
print(
    f'La frase "porque porque porque" ha sido eliminada: {sentence.replace('porque','')}'
)
print("\n")
...
# 10.1.-
print(
    f'Comprobando si la oración comienza con "Aprendiendo": {sentence2.startswith('Aprendiendo')}'
)

# 10.2.-
print(
    f'Comprobando si la oración termina con "Aprendiendo": {sentence2.endswith('Aprendiendo')}'
)
...
area = 3.14 * radius**2
print(
    "El área de un circulo con el rado de {}cm es {}cm cuadrados.".format(radius, area)
)
